...
import { translateObjectToMarathi } from '@/lib/utils';
...
export const seedContent: SiteContent = {
  hero: {
    ...
    backgroundImage: '/Adv Homepage.jpeg',
    stats: [
      { label: 'Cases Resolved', value: '1,500+' },
  ...
  aboutSection: {
    ...
    experience: '15+',
    casesHandled: '1,500+',
    description: 'Advocate A.N. Qureshi is a highly respected legal professional specializing in Cyber Crime, Cheque Bounce proceedings, Family Court matters, and diverse Civil and Criminal cases. Based in Beed, he is committed to providing strategic and results-oriented legal solutions.',
    highlights: [
      { label: 'Cyber Crime', value: 'Expert' },
      { label: 'Cheque Bounce', value: 'Senior' },
      { label: 'Family Law', value: 'Specialist' },
  ...
  aboutPage: {
    ...
    heroSubtitle: 'Serving Beed and surrounding regions with distinguished legal expertise for over 15 years. Led by Adv. A.N. Qureshi, we specialize in Civil, Criminal, and Cyber law.',
    advocateName: 'Adv. A.N. Qureshi',
    advocateTitle: 'M.Com, LL.B., G.D.C & A.',
  ...
  contact: {
    ...
    address: 'Humayun Plaza, Opp. Post office, Bashir Gunj, Beed - 431122',
    phone: '+91 98223 06066',
    officePhone: '+91 98223 06066',
    email: 'anq.beed@gmail.com',
    inquiryEmail: 'anq.beed@gmail.com',
